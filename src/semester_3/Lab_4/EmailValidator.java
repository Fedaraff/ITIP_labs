...
public class EmailValidator {
    ...
    public static void logs(String text){
        try{
            FileWriter writer = new FileWriter("src/semester_3.Lab_4/logs.txt", true);
            writer.write(text + "\n");
            writer.close();
        } catch (IOException e){
    ...
    public static void main(String[] args) {
        String[] emails = {"semester_3.test@example.com", "invalid-email", "another@semester_3.test.ru"};
